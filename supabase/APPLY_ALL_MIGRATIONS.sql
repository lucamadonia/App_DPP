-- ============================================
-- CONSOLIDATED MIGRATIONS - APPLY ALL AT ONCE
-- ============================================
-- This file contains ALL critical migrations
-- Apply this in Supabase SQL Editor
-- ============================================

-- Migration 1: Fix handle_new_user trigger (CRITICAL!)
-- File: 20260201_fix_handle_new_user.sql
-- ============================================
...
-- ============================================
-- Migration 2: Public ticket creation RLS
-- File: 20260204_public_ticket_creation.sql
-- ============================================
...
-- ============================================
-- Migration 3: Visibility public policy
-- File: 20260201_visibility_public_policy.sql
-- ============================================
...
-- Customer registration should now work
-- ============================================
