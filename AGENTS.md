...
- **AI**: OpenRouter API → Codex Sonnet 4 (streaming compliance analysis)
...
| File | Purpose |
|------|---------|
| `client.ts` | HTTP streaming client for OpenRouter API (Codex Sonnet 4) |
...
AI-powered EU product compliance analysis using Codex Sonnet 4 via OpenRouter. Performs a 3-phase streaming analysis, generates compliance scores, findings, action plans, and exports PDF reports.
...
# Optional (frontend)
VITE_OPENROUTER_API_KEY=sk-or-...    # OpenRouter API key for AI compliance analysis (Codex Sonnet 4)
