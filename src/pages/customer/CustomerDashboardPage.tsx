...
import { gridStagger, gridItem, blurIn } from '@/lib/motion';
...
export function CustomerDashboardPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div variants={prefersReduced ? undefined : blurIn}>
        <GlassCard
          className="p-6 text-white relative overflow-hidden border-0"
      ...
      {stats && (
        <motion.div variants={prefersReduced ? undefined : gridItem}>
          <CustomerKPICards stats={stats} />
        </motion.div>
      )}

      {/* Quick Actions */}
      <motion.div className="flex flex-wrap gap-3" variants={prefersReduced ? undefined : gridItem}>
        <Button
