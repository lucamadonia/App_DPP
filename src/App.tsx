...
const TransparencyConfigPage = lazy(() => import('@/pages/TransparencyConfigPage').then(m => ({ default: m.TransparencyConfigPage })));
...
const ShipmentReportsPage = lazy(() => import('@/pages/warehouse/ShipmentReportsPage').then(m => ({ default: m.ShipmentReportsPage })));
const InventoryDriftPage = lazy(() => import('@/pages/warehouse/InventoryDriftPage').then(m => ({ default: m.InventoryDriftPage })));
...
const CampaignListPage = lazy(() => import('@/pages/warehouse/CampaignListPage').then(m => ({ default: m.CampaignListPage })));
...
const ComplianceSettingsPage = lazy(() => import('@/pages/compliance/ComplianceSettingsPage').then(m => ({ default: m.ComplianceSettingsPage })));
const ComplianceAuditPage = lazy(() => import('@/pages/compliance/ComplianceAuditPage').then(m => ({ default: m.ComplianceAuditPage })));
    ...
    <BrowserRouter>
      ...
      <Routes>
        ...
        <Route element={<EmbedLayout />}>
          <Route path="embed/portal/:tenantSlug" element={<PublicReturnPortalPage />} />
        ...
        <Route element={<ProtectedRoute />}>
          ...
          <Route path="warehouse/campaigns" element={<CampaignListPage />} />
          <Route path="warehouse/campaigns/new" element={<CampaignFormPage />} />
