    ...
    <>
      ...
      {mobileOpen && (
        <div className="fixed inset-0 z-40 lg:hidden">
          ...
          <div className="absolute top-16 right-0 w-[min(288px,90vw)] max-h-[calc(100dvh-4rem)] overflow-y-auto bg-white/95 backdrop-blur-xl border-l border-slate-200 shadow-xl rounded-bl-2xl animate-landing-reveal pt-[var(--safe-top)] pb-[var(--safe-bottom)]">
