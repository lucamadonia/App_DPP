...
export function SupplierDataRequestsTable({ requests, onRefresh }: SupplierDataRequestsTableProps) {
  ...
  const columns: ResponsiveTableColumn<SupplierDataRequest>[] = [
    {
      id: 'products',
      header: t('Products'),
      className: 'font-medium',
      mobilePriority: 'title',
      cell: (req) => <ProductsCell req={req} />,
    },
    {
      id: 'supplier',
      header: t('Supplier'),
      mobilePriority: 'subtitle',
      cell: (req) => req.supplierName || '—',
    },
    {
      id: 'status',
      header: t('Status'),
    ...
    },
    {
      ...
      cell: (req) => formatDate(req.createdAt, locale),
    },
    {
      id: 'expires',
      header: t('Expires'),
      ...
      cell: (req) => formatDate(req.expiresAt, locale),
    },
    {
      id: 'actions',
      header: t('Actions'),
